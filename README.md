...
```
composer require aurigma/accounting-service-operational-api-client
```
...
{
  "require": {
    "aurigma/accounting-service-operational-api-client": "*@dev"
  }
}
```
...
$config = Aurigma\AccountingServiceOperational\Configuration::getDefaultConfiguration()->setApiKey('X-API-Key', 'YOUR_API_KEY');

// Configure OAuth2 access token for authorization: OAuth2ClientCredentials
$config = Aurigma\AccountingServiceOperational\Configuration::getDefaultConfiguration()->setAccessToken('YOUR_ACCESS_TOKEN');

$apiInstance = new Aurigma\AccountingServiceOperational\Api\BuildInfoApi(
